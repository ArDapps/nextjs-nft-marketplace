...
export default function ArtPreview () {
    return (
        <div className='flex flex-col lg:flex-row items-center space-x-0 space-y-8 lg:space-x-8 lg:space-y-0 bg-[#161A42] rounded-md p-6'>
            ...
            <div className='flex-1 flex flex-col lg:flex-row space-x-0 space-y-8 lg:space-x-8 lg:space-y-0'>
                <div className='flex-grow text-white'>
                    ...
                    <p className='text-[#B4BAEF] text-base my-6'>Sell your items with price and also have ability to cancel anytime from sale and edit price can work at etherum and bnb and polygon net, any network with solidity</p>
                        ...
                        <div className='flex-1 flex flex-col space-y-6'>
                            <div className='flex flex-row space-x-4'>
                                ...
                                <div className='flex-grow flex flex-col'>
                                    <p className='text-[#7D82B2] text-base'>Onwerd By</p>
                                    <p className='text-white text-base font-bold'>Account Address</p>
                                </div>
                            </div>
                        ...
                        <div className='flex-1 flex flex-col space-y-6'>
                            <div className='flex flex-row space-x-4'>
                                ...
                                <div className='flex flex-col'>
                                    <p className='text-[#7D82B2] text-base'>Created By</p>
                                    <p className='text-white text-base font-bold'>Account Address</p>
                                </div>
                            </div>

                            <button className='w-48 rounded-full border bg-[#161A42] text-white text-base py-2 shadow-md m-auto ml-0'>Share</button>
                        </div>
                    </div>
                </div>
