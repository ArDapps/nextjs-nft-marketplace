            ...
            <div className="min-h-screen px-4 text-center">
                ...
                <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-[#24274D] dark:bg-white shadow-xl">
                    ...
                    <div className='flex flex-col items-center space-y-4'>
                        ...
                        <div className='pt-4'>
                            <button className='rounded-full bg-gradient-to-b from-[#3461FF] to-[#8454EB] text-white text-base px-16 py-2 shadow-md' onClick={props.closeSuccessModal}>View</button>
                        </div>
