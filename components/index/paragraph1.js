    ...
    return (
        <div className='flex flex-row'>
            ...
            <div className='relative'>
                <div className='absolute top-[12vw] left-[9vw] w-[80vw] md:w-[50vw] lg:w-[40vw] flex flex-col text-white dark:text-gray-800'>
                    ...
                    <div className='flex-1 flex flex-row gap-8 mt-[4vw]'>
                        <div className=''>
                            <button className='rounded-full bg-gradient-to-b from-[#3461FF] to-[#8454EB] text-white text-base px-6 sm:px-10 py-2 shadow-lg'>Collection</button>
                        </div>
                        <div className=''>
                            <button className='rounded-full border text-base px-6 sm:px-10 py-2 dark:border-gray-300 shadow-lg'>Create NFT</button>
                        </div>
                    </div>
                </div>
            </div>
